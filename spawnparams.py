...
ItemSpawns.append(ItemSpawnParams( I.Aegis(312),              1,               5,          1,              1))
ItemSpawns.append(ItemSpawnParams( I.TowerShield(313),        1,               5,          1,              1))
ItemSpawns.append(ItemSpawnParams( I.MagicFocus(314),         1,               5,          1,              1))
ItemSpawns.append(ItemSpawnParams( I.Chestarmor(600),              1,               5,          0,              0))
ItemSpawns.append(ItemSpawnParams( I.LeatherArmor(601)         ,1,               5,          1,              1))
ItemSpawns.append(ItemSpawnParams( I.GildedArmor(602),         1,               5,          1,              1))
ItemSpawns.append(ItemSpawnParams( I.WarlordArmor(603),        1,               5,          1,              1))
ItemSpawns.append(ItemSpawnParams( I.WizardRobe(604),          1,               5,          1,              1))
...
ItemSpawns.append(ItemSpawnParams( I.Gauntlets(751),           1,               5,          1,              1))
ItemSpawns.append(ItemSpawnParams( I.HealthPotion(401),       1,               10,          0,              0))
ItemSpawns.append(ItemSpawnParams( I.Dagger(321),             1,               10,          0,              0))
ItemSpawns.append(ItemSpawnParams( I.RingOfSwiftness(500),               1,               10,          0,              0))
ItemSpawns.append(ItemSpawnParams( I.FlamingSword(331),       1,               10,          0,              0))
ItemSpawns.append(ItemSpawnParams( I.MagicWand(332),          1,               10,          1,              1))
ItemSpawns.append(ItemSpawnParams( I.VikingHelmet(771),       1,               10,          0,              0))
ItemSpawns.append(ItemSpawnParams( I.BootsOfEscape(701),      1,               10,          0,              0))
ItemSpawns.append(ItemSpawnParams( I.BloodRing(501),          1,               10,          0,              0))
ItemSpawns.append(ItemSpawnParams( I.RingOfMana(502),          1,               10,          0,              0))
ItemSpawns.append(ItemSpawnParams( I.RingOfMight(503),          1,               10,          0,              0))
ItemSpawns.append(ItemSpawnParams( I.BoneRing(504),          1,               10,          0,              0))
