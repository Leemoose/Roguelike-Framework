...
def create_trade_screen(display, loop):
    ...
    print(player_offset_left)
    print(player_offset_top)
    print(dialogue_window_width)
    print(dialogue_window_height)
    print(dialogue_window_offset_left)
    print(dialogue_window_offset_top)
